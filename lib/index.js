...
export class YePanel extends plugin {
    ...
    async installWeb(e) {
        ...
        try {
            ...
            e.reply(`安装web服务失败: ${error.message}, 请检查网络或手动克隆仓库到plugins目录下, 安装命令: git clone --depth=1 -b gh-pages https://github.moeyy.xyz/https://github.com/XasYer/YePanel.git ./plugins/YePanel-Web/\n`);
            run = false;
            return;
        }
